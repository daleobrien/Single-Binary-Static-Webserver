...
pub(super) fn build_version_headers(
...
) -> (usize, usize, bool, bool, Vec<Vec<(String, String)>>, usize) {
    ...
    let version_use_brotli = !version_use_uncomp && version_br_data.len() < version_gz_data.len();
